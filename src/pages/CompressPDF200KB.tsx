...
const CompressPDF200KB = () => {
  ...
  return (
    <ToolLayout
      ...
      description="Automatically compress your PDF to approximately 200KB"
    >
      <div className="space-y-6">
        ...
        <div className="bg-muted/50 rounded-lg p-4 text-sm text-muted-foreground">
          <p><strong>Note:</strong> The tool automatically finds the best quality setting to achieve ~200KB. Very large PDFs with many pages may not reach this target.</p>
        </div>
      </div>
    </ToolLayout>
  );
