...
const Index = () => {
  const tools = [
    ...
    },
    {
      title: "Sign PDF",
      description:
        "Add your signature to PDF documents. Draw or upload a signature image.",
      icon: PenTool,
      link: "/sign-pdf",
      highlight: true,
    },
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Everything you need to compress, convert, merge, and manage your
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Unlike other online tools, we don't upload your files to any
              server. All document processing happens entirely within your
              browser using client-side JavaScript. This means your sensitive
              documents—whether they're ID cards, financial records, or personal
              files—never leave your computer. Complete privacy, guaranteed.
            </p>
          </div>
        </div>
      </section>
